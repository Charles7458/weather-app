...
function App() {
    ...
    async function getCity(){
        ...
        if(res){
            ...
            setIsSaved(savedLocations.some(loc=> (loc.name==location.city && loc.country_code==location.countryCode) || (loc.coords.lat===location.latitude && loc.coords.lon===location.longitude)))
